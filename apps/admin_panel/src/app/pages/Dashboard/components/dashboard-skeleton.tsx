...
const skeletonTone = 'bg-sea-pale/50';
const skeletonToneMuted = 'bg-sea-pale/40';
...
function CardHeaderSkeleton({
  ...
  return (
    ...
    >
      {withIcon && (
        <Skeleton className={cn('size-10 shrink-0 rounded-xl', skeletonTone)} />
      )}
      <div className="min-w-0 flex-1 space-y-2">
        <Skeleton className={cn('h-6 w-44 max-w-full', skeletonTone)} />
        <Skeleton className={cn('h-4 w-full max-w-[16rem]', skeletonToneMuted)} />
      </div>
    </header>
  );
}
    ...
    <li className={cn('space-y-2', className)}>
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <Skeleton className={cn('size-8 shrink-0 rounded-lg', skeletonTone)} />
          <Skeleton className={cn('h-5 w-20', skeletonToneMuted)} />
        </div>
        <Skeleton className={cn('h-5 w-16', skeletonToneMuted)} />
      </div>
      <Skeleton className={cn('h-2 w-full rounded-full', skeletonToneMuted)} />
    </li>
  );
}
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          ...
          >
            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              <Skeleton className="h-3.5 w-full max-w-[10rem] rounded-md" />
            </div>
    ...
    <DashboardCardSkeleton className="min-h-[22rem] w-full">
      ...
      <div className="mb-6 grid shrink-0 grid-cols-2 gap-3">
        {Array.from({ length: 2 }).map((_, i) => (
          ...
          >
            <Skeleton className={cn('mb-2 size-9 rounded-lg', skeletonTone)} />
            <Skeleton className={cn('mb-2 h-3.5 w-16', skeletonToneMuted)} />
            <Skeleton className={cn('mb-1 h-7 w-12', skeletonTone)} />
            <Skeleton className={cn('h-3 w-10', skeletonToneMuted)} />
          </div>
        ))}
      </div>
        ...
        {Array.from({ length: 2 }).map((_, i) => (
          <div key={i} className="space-y-1.5">
            <div className="flex justify-between">
              <Skeleton className={cn('h-4 w-16', skeletonToneMuted)} />
              <Skeleton className={cn('h-4 w-10', skeletonToneMuted)} />
            </div>
            <Skeleton className={cn('h-2 w-full rounded-full', skeletonToneMuted)} />
          </div>
        ))}
      </div>
      <Skeleton className={cn('mt-4 h-10 w-full rounded-lg', skeletonToneMuted)} />
    </DashboardCardSkeleton>
  );
}
      ...
      <div className="flex flex-1 flex-col justify-center space-y-5">
        {Array.from({ length: 2 }).map((_, i) => (
          <div key={i} className="space-y-2">
            ...
            <Skeleton className={cn('h-2 w-full rounded-full', skeletonToneMuted)} />
            <Skeleton className={cn('h-3.5 w-36', skeletonToneMuted)} />
          </div>
        ))}
      </div>
      <div className="mt-5 shrink-0 rounded-xl border border-dashed border-sea-light/60 bg-sea-foam/40 p-4">
        <Skeleton className={cn('mb-3 h-4 w-52', skeletonToneMuted)} />
        <div className="flex flex-col gap-3 sm:flex-row sm:gap-6">
          <Skeleton className={cn('h-6 w-36', skeletonToneMuted)} />
          <Skeleton className={cn('h-6 w-32', skeletonToneMuted)} />
        </div>
      </div>
    </DashboardCardSkeleton>
  );
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          ...
          >
            <div className="mb-2 flex items-center justify-between">
              <Skeleton className={cn('h-4 w-24', skeletonTone)} />
              <Skeleton className={cn('h-5 w-10', skeletonToneMuted)} />
            </div>
            <Skeleton className={cn('h-2 w-full rounded-full', skeletonToneMuted)} />
            <Skeleton className={cn('mt-2 h-3.5 w-full max-w-[12rem]', skeletonToneMuted)} />
          </li>
        ))}
      </ul>
    </DashboardCardSkeleton>
  ...
  return (
    <div className="admin-card-surface w-full shrink-0 rounded-2xl border border-sea-light/45 bg-gradient-to-br from-white via-white to-sea-foam/40 p-4 shadow-sm sm:p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 flex-1 space-y-2">
          <Skeleton className={cn('h-5 w-36', skeletonTone)} />
          <Skeleton className={cn('h-4 w-full max-w-md', skeletonToneMuted)} />
        </div>
        <Skeleton className={cn('h-9 w-28 shrink-0 rounded-xl', skeletonToneMuted)} />
      </div>
      <div className="mt-4 flex flex-wrap gap-2">
        {Array.from({ length: 6 }).map((_, i) => (
          <Skeleton key={i} className={cn('h-10 w-14 rounded-xl', skeletonToneMuted)} />
        ))}
      </div>
    </div>
  );
  ...
  return (
    <DashboardCardSkeleton className="min-h-[20rem] w-full flex-1">
      <header className="mb-4 flex shrink-0 items-start justify-between gap-3">
        <div className="min-w-0 flex-1 space-y-2">
          <Skeleton className={cn('h-6 w-40', skeletonTone)} />
          <Skeleton className={cn('h-4 w-full max-w-xs', skeletonToneMuted)} />
        </div>
        <div className="flex shrink-0 gap-2">
          <Skeleton className={cn('h-7 w-20 rounded-lg', skeletonToneMuted)} />
          <Skeleton className={cn('h-7 w-16 rounded-lg', skeletonToneMuted)} />
        </div>
      </header>
      <Skeleton className={cn('mb-4 h-11 w-full rounded-xl', skeletonToneMuted)} />
      <ul className="flex flex-1 flex-col space-y-2">
        {Array.from({ length: rowCount }).map((_, i) => (
          ...
          >
            <Skeleton className={cn('size-7 shrink-0 rounded-lg', skeletonToneMuted)} />
            <Skeleton className={cn('size-9 shrink-0 rounded-full', skeletonTone)} />
            <div className="min-w-0 flex-1 space-y-1.5">
              <Skeleton className={cn('h-4 w-32', skeletonTone)} />
              <Skeleton className={cn('h-3 w-20', skeletonToneMuted)} />
            </div>
            <Skeleton className={cn('h-4 w-16 shrink-0', skeletonToneMuted)} />
          </li>
        ))}
      </ul>
    </DashboardCardSkeleton>
  ...
  return (
    <DashboardCardSkeleton padding="none" className="min-h-[18rem]">
      <header className="shrink-0 border-b border-sea-light/40 px-5 py-4 sm:px-6">
        <Skeleton className={cn('h-6 w-44', skeletonTone)} />
        <Skeleton className={cn('mt-2 h-4 w-72 max-w-full', skeletonToneMuted)} />
      </header>
      <div className="flex flex-1 flex-col overflow-hidden">
        <div className="grid shrink-0 grid-cols-4 gap-3 border-b border-sea-light/30 bg-sea-foam/50 px-5 py-3 sm:px-6">
          {Array.from({ length: 4 }).map((_, i) => (
            <Skeleton key={i} className={cn('h-3.5 w-full max-w-[5rem]', skeletonToneMuted)} />
          ))}
        </div>
        <ul className="divide-y divide-sea-light/20">
          {Array.from({ length: rowCount }).map((_, i) => (
            <li key={i} className="flex items-center gap-3 px-5 py-3.5 sm:px-6">
              <Skeleton className={cn('size-10 shrink-0 rounded-full', skeletonTone)} />
              <div className="min-w-0 flex-1 space-y-1.5">
                <Skeleton className={cn('h-4 w-36', skeletonTone)} />
                <Skeleton className={cn('h-3 w-48 max-w-full', skeletonToneMuted)} />
                <Skeleton className={cn('h-3 w-28', skeletonToneMuted)} />
              </div>
              <Skeleton className={cn('hidden h-6 w-16 shrink-0 rounded-lg sm:block', skeletonToneMuted)} />
              <Skeleton className={cn('hidden h-6 w-14 shrink-0 sm:block', skeletonToneMuted)} />
              <Skeleton className={cn('hidden h-4 w-20 shrink-0 sm:block', skeletonToneMuted)} />
            </li>
          ))}
        </ul>
      </div>
