  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none  disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        primary:
          'h-20 rounded-xl bg-gradient-to-r from-[#023047] via-[#0077b6] to-[#00b4d8] text-base font-semibold text-white shadow-lg shadow-[#0077b6]/30 transition-all hover:shadow-xl hover:brightness-110 disabled:opacity-70',
        special:
