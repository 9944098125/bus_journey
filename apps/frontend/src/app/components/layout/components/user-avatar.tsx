...
export default function UserAvatar() {
  ...
  return (
    <div
      className={cn(
        'flex min-w-0 items-center gap-3 rounded-2xl border-2 border-rose-100/50 bg-white/10 px-2.5 py-2',
    ...
    >
      ...
      >
        {profilePicture ? (
          ...
          <span className="text-2xl font-bold tracking-tight text-[#722f37]">
            {initials}
          </span>
        )}
      </div>
