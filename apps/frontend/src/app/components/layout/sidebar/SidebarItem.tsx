...
const badgeStyles = {
  ...
  warning: 'bg-amber-400/25 text-amber-100 ring-1 ring-amber-400/35',
  success: 'bg-emerald-400/22 text-emerald-100 ring-1 ring-emerald-400/35',
  destructive: 'bg-rose-400/22 text-rose-50 ring-1 ring-rose-400/35',
  accent: 'bg-sky-400/22 text-sky-50 ring-1 ring-sky-400/35',
} as const;
  ...
  return (
    <span
      className={cn(
        ...
        badgeStyles[variant],
        collapsed
          ? 'absolute -right-0.5 -top-0.5 size-2 rounded-full p-0 ring-2 ring-[#1a3348]'
          : isLive
            ? 'px-2 py-0.5'
    ...
    <>
        ...
        (animatedActive ? (
          <motion.span
            ...
            className={cn(
              ...
              'bg-gradient-to-r from-[#ff7b54]/35 via-[#38bdf8]/25 to-[#34d399]/20',
              'shadow-[inset_0_1px_0_rgba(255,255,255,0.18),0_8px_28px_-10px_rgba(56,189,248,0.55)]',
          ...
          <span
            className={cn(
              'absolute inset-0 rounded-2xl',
              'bg-gradient-to-r from-[#ff7b54]/35 via-[#38bdf8]/25 to-[#34d399]/20',
              'shadow-[inset_0_1px_0_rgba(255,255,255,0.18)] ring-1 ring-white/20',
            )}
            aria-hidden
          />
        ))}
      ...
      <motion.span
        className={cn(
          ...
          isActive
            ? 'bg-white/14 text-white shadow-[0_8px_24px_-8px_rgba(255,123,84,0.55)]'
            : 'bg-white/0 text-white/55 group-hover:bg-white/10 group-hover:text-white/95',
        )}
      ...
      {!collapsed && (
        ...
        >
          <span
            className={cn(
              isActive ? 'text-white' : 'text-white/65 group-hover:text-white/92',
            )}
          >
            {item.title}
          </span>
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          ...
          'focus-visible:ring-2 focus-visible:ring-sky-300/70 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent',
